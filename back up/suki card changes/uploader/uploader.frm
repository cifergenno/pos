...
rs4.Open "SELECT STOCK_ON_HAND from stock_info where ITEM_CODE like " & "'" & UCase(Text1.Text) & "%'", conn
...
rs8.Open "SELECT DATE_RECEIVED FROM stock_info where ITEM_CODE like " & "'" & UCase(Text1.Text) & "%'", conn
rs9.Open "SELECT ITEM_CODE FROM stock_info where ITEM_CODE like " & "'" & UCase(Text1.Text) & "%'", conn
...
margin = (Val(Text8.Text) - Val(Text6.Text)) / (Val(Text6.Text))
margin = margin * 100
Dim marg_peso As Double
marg_peso = (Val(Text8.Text) - Val(Text6.Text))
