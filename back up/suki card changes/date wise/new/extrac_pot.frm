...
For aaaa = 1 To Val(Text4.Text)
    ...
    report(1) = trimer(0)
        ...
        rs6.Open "SELECT RP FROM date_wise where DATE_SOLD like '" & report(1) & "%'", conn
...
mail:
               ...
               If report(9) <> 0 Then
                conn.Execute "INSERT INTO date_wise (RCP,DISCOUNT, DATE_SOLD,GROSS_SALE, GROSS_MARGIN,SUKI,QTY_SOLD)" _
