...
GRoss_pay = Text6.Text
use_suki = Text11.Text
...
'MsgBox "points"
  conn.Execute "INSERT INTO sales (DATE_SOLD,CATEGORY, MODEL,DESCRIPTION,ITEM_CODE,PCS, RECEIVED, SUPPLIER, CP, RP, TOTAL, CASHER,INVOICE,MARGIN_PESO,DISCOUNT, GROSS)" _
        & "values ('" & Now & "', '" & cat & "', '" & mods & "','" & LTrim(main.grid2.TextMatrix(qq, 2)) & "', '" & LTrim(main.grid2.TextMatrix(qq, 1)) & "_SUKI_CARD-" & "', '" & LTrim(main.grid2.TextMatrix(qq, 3)) & "', '" & pitsa & "', '" _
...
conn.Execute "INSERT INTO sales (DATE_SOLD, CASHER,INVOICE,DISCOUNT, GROSS,DESCRIPTION, TOTAL, ITEM_CODE)" _
        & "values ('" & Now & "', '" & main.casher.Text & "', '" & main.invoice.Text & "', '" & use_suki & "', '" & GRoss_pay _
        & "', '" & "Suki Card ----- " & Text1.Text & "','" & sudli & "','" & "-SUKI_CARD-" & "')"
...
End If
    ...
    conn.Execute "INSERT INTO sales (DATE_SOLD,CATEGORY, MODEL,DESCRIPTION,ITEM_CODE,PCS, RECEIVED, SUPPLIER, CP, RP, TOTAL, CASHER,INVOICE,MARGIN_PESO,DISCOUNT, GROSS)" _
        ...
        & "--------" & "', '" & "--------" & "', '" & "--------" & "', '" & Text7.Text & "', '" & main.casher.Text & "', '" & main.invoice.Text & "', '" & "--------" & "', '" & "--------" & "', '" & "-------" & "')"
